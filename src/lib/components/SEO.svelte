	...
	<script type="application/ld+json">
		{
			...
			"alternateName": ["Cornelius Yoga", "CZY"],
			...
			"alumniOf": {
				...
				"alternateName": ["UKSW", "Universitas Kristen Satya Wacana"]
			},
			"address": {
				"@type": "PostalAddress",
	...
	<script type="application/ld+json">
		{
			"@context": "https://schema.org",
			"@type": "ItemList",
			"name": "Selected Portfolio Evidence",
			"itemListElement": [
				{
				...
				},
				{
					...
					"position": 2,
					"name": "TanyaBuah",
					"description": "Educational Android fruit recognition app using Kotlin, Jetpack Compose, and MobileNetV2 image classification.",
					"url": "https://github.com/CZY774/TTU",
				...
				},
				{
					...
					"position": 3,
					"name": "EduVerse",
					"description": "Educational platform UI/UX prototype for junior high school learning workflows.",
					"url": "https://www.figma.com/proto/iADoy42ojxwFJrOPRwKbAi/EduVerse-by-Belum-Ada-Ide"
				},
				{
					"@type": "SoftwareApplication",
					"position": 4,
					"name": "Muncul River Tubing",
					"description": "Laravel and MySQL tourism website for a local river-tubing destination.",
					"url": "https://munculrivertubing.com",
					"applicationCategory": "WebApplication"
				}
			]
		}
